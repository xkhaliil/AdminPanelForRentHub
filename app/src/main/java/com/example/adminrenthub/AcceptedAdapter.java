...
public class AcceptedAdapter extends RecyclerView.Adapter<AcceptedViewHolder> {
    FirebaseFirestore db = FirebaseFirestore.getInstance();
    Context context;
    List<Rents> rentsList;
    public AcceptedAdapter(Context context, List<Rents> rentsList) {
    ...
    public AcceptedViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new AcceptedViewHolder(LayoutInflater.from(context).inflate(R.layout.accepted_item,parent,false));
    }
